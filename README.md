...
| ----                                      | -----------                               | :-------: | -------            | -----                       | -----                                                                             |
| APPINSIGHTS_CLOUDROLE                     | Role used for filtering metrics           | no        |                    |                             | Set to `ffc-grants-eligibility` in docker compose files                               |
...
available on ASB e.g. `ffc-grants-eligibility-<initials>` where `<initials>` are the
...
kubectl port-forward --namespace=ffc-grants deployment/ffc-grants-eligibility 3000:3000
```
